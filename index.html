...
<html lang="en">
    ...
    <body>
            ...
            <nav>
                <div class="row">
                    ...
                    <ul class="main-nav js--main-nav">
                        <li><a href="#feature">Food Delievery</a></li>
        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    ...
                    <a href="#" class="bttn-app"><img src="img/download-app.svg" alt="App Store Button"></a>
                    <a href="#" class="bttn-app"><img src="img/download-app-android.png" alt="Play Store Button"></a>
                </div>
            </div>
        </section>
        ...
        <footer>
            ...
            <div class="row">
                <p>
                    Copyright &copy; 2019 by Olomola Ebenezer. All right reserved.
                </p>
            </div>
        </footer>
